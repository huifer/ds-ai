    ...
    <div className="min-h-screen bg-surface text-brand-primary">
      <header className="bg-brand-primary text-white">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <p className="text-xs uppercase tracking-widest text-cyan-200">Zenbuild · Showcase</p>
          <Hero
            title="Ship a SaaS homepage in days, not weeks."
            tagline="A minimal, opinionated React + Vite starter designed for fast product demos. Tailwind v3, shadcn-friendly tokens, MSW mocks, and TanStack Query out of the box."
            badge="v0.1 · showcase"
            cta={{ label: 'See live demo', href: '#features' }}
          />
